...
int HelloCoordinateSystemMain()
{
    ...
    // 处理着色器
    Shader ourShader("./src/Chapter6-CoordinateSystem/shader.vs", "./src/Chapter6-CoordinateSystem/shader.fs");
