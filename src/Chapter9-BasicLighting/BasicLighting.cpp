...
#pragma endregion
    ...
    // 着色器
    Shader objectShader("./src/Chapter9-BasicLighting/shader.vs", "./src/Chapter9-BasicLighting/shader.fs");
    Shader lightShader("./src/Chapter9-BasicLighting/shader.vs", "./src/Chapter9-BasicLighting/lightShader.fs");
