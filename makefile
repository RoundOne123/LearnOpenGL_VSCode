...
SRC = $(wildcard src/*.cpp src/Chapter1-Hello-Window/*.cpp src/Chapter2-Hello-Triangle/*.cpp src/Chapter3-Shader/*.cpp src/Chapter4-Texture/*.cpp src/Chapter5-Transform/*.cpp)
EXECUTABLE := main
